...
export default function EditHabitPage() {
  ...
  function renderStep() {
    switch (currentStep) {
      case 1: return <Step1 formData={formData} onChange={handleChange} />
      case 2: return <Step2 formData={formData} onChange={handleChange} />
      case 3: return <Step3 formData={formData} onChange={handleChange} />
      case 4: return <Step4 formData={formData} onChange={handleChange} />
      case 5: return <Step5 formData={formData} onChange={handleChange} />
      case 6: return <Step6 formData={formData} onChange={handleChange} />
      case 7: return <Step7 formData={formData} onChange={handleChange} />
      default: return null
    }
  }
